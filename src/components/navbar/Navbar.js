            ...
            <div className="flex flex-col gap-8 py-2 relative">
              <div>
                ...
                <p className="text-sm text-gray-400 mt-2">
                  As the leader of nextCode24's online developer course, I am
                  dedicated to empowering students with essential programming
                  skills. Currently studying programming in China.
                </p>
              </div>
